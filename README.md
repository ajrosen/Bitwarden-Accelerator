![GitHub Release](https://img.shields.io/github/v/release/ajrosen/bitwarden-accelerator?logo=bitwarden)
![GitHub Downloads (specific asset, latest release)](https://img.shields.io/github/downloads/ajrosen/bitwarden-accelerator/latest/Bitwarden.Accelerator.alfredworkflow?displayAssetName=false&label=downloads)
![GitHub Downloads (specific asset, all releases)](https://img.shields.io/github/downloads/ajrosen/bitwarden-accelerator/Bitwarden.Accelerator.alfredworkflow?label=total%20downloads&displayAssetName=false)
...
If your web browser is the front-most window, the default *Name* will be the active tab's domain name. See *[Supported browsers](#browsers)* below.

The default *Username* will be your Bitwarden email address.

The default *Password* will be a random password generated by Bitwarden.  It is 20 characters and includes uppercase letters, lowercase letters, numbers, and special characters.  The new password can also be copied to your clipboard as if it had been selected from the items list.
